...
MaxPower is a prometheus exporter for SOLARMAX inverters. It is intended to query SOLARMAX inverter data using an [reverse-engineered](https://2007.blog.dest-unreach.be/2009/04/15/solarmax-maxtalk-protocol-reverse-engineered/) implementation of their proprietary MaxTalk protocol, called [MaxTalkSharp](/MaxTalkSharp).
